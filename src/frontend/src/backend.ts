...
export class Backend implements backendInterface {
    ...
    async getMyStreakStats(): Promise<StreakStats> {
        if (this.processError) {
            try {
                const result = await this.actor.getMyStreakStats();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTimeBreakdown(): Promise<TimeBreakdown> {
        if (this.processError) {
            try {
                const result = await this.actor.getTimeBreakdown();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async markDomainComplete(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.markDomainComplete(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async markLessonRead(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.markLessonRead(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async markSimulationDone(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.markSimulationDone(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async recordTimeSpent(arg0: string, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.recordTimeSpent(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitQuiz(arg0: string, arg1: bigint, arg2: boolean): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateStreakStats(arg0: bigint): Promise<StreakStats> {
        if (this.processError) {
            try {
                const result = await this.actor.updateStreakStats(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
